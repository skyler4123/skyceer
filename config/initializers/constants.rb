...
COUNTRY = [
  ...
  { name: "Bahamas (the)", iso2: "BS", iso3: "BHS", numeric: "044" },
  ...
  { name: "Bolivia (Plurinational State of)", iso2: "BO", iso3: "BOL", numeric: "068" },
  { name: "Bonaire, Sint Eustatius and Saba", iso2: "BQ", iso3: "BES", numeric: "535" },
  ...
  { name: "British Indian Ocean Territory (the)", iso2: "IO", iso3: "IOT", numeric: "086" },
  ...
  { name: "Cayman Islands (the)", iso2: "KY", iso3: "CYM", numeric: "136" },
  { name: "Central African Republic (the)", iso2: "CF", iso3: "CAF", numeric: "140" },
  ...
  { name: "Cocos (Keeling) Islands (the)", iso2: "CC", iso3: "CCK", numeric: "166" },
  { name: "Colombia", iso2: "CO", iso3: "COL", numeric: "170" },
  { name: "Comoros (the)", iso2: "KM", iso3: "COM", numeric: "174" },
  { name: "Congo (the Democratic Republic of the)", iso2: "CD", iso3: "COD", numeric: "180" },
  { name: "Congo (the)", iso2: "CG", iso3: "COG", numeric: "178" },
  { name: "Cook Islands (the)", iso2: "CK", iso3: "COK", numeric: "184" },
  ...
  { name: "Dominican Republic (the)", iso2: "DO", iso3: "DOM", numeric: "214" },
  ...
  { name: "Falkland Islands (the) [Malvinas]", iso2: "FK", iso3: "FLK", numeric: "238" },
  { name: "Faroe Islands (the)", iso2: "FO", iso3: "FRO", numeric: "234" },
  ...
  { name: "French Southern Territories (the)", iso2: "TF", iso3: "ATF", numeric: "260" },
  { name: "Gabon", iso2: "GA", iso3: "GAB", numeric: "266" },
  { name: "Gambia (the)", iso2: "GM", iso3: "GMB", numeric: "270" },
  ...
  { name: "Heard Island and McDonald Islands", iso2: "HM", iso3: "HMD", numeric: "334" },
  { name: "Holy See (the)", iso2: "VA", iso3: "VAT", numeric: "336" },
  ...
  { name: "Iran (Islamic Republic of)", iso2: "IR", iso3: "IRN", numeric: "364" },
  ...
  { name: "Korea (the Democratic People's Republic of)", iso2: "KP", iso3: "PRK", numeric: "408" },
  ...
  { name: "Lao People's Democratic Republic (the)", iso2: "LA", iso3: "LAO", numeric: "418" },
  ...
  { name: "Marshall Islands (the)", iso2: "MH", iso3: "MHL", numeric: "584" },
  ...
  { name: "Micronesia (Federated States of)", iso2: "FM", iso3: "FSM", numeric: "583" },
  { name: "Moldova (the Republic of)", iso2: "MD", iso3: "MDA", numeric: "498" },
  ...
  { name: "Netherlands (the)", iso2: "NL", iso3: "NLD", numeric: "528" },
  ...
  { name: "Niger (the)", iso2: "NE", iso3: "NER", numeric: "562" },
  ...
  { name: "Northern Mariana Islands (the)", iso2: "MP", iso3: "MNP", numeric: "580" },
  ...
  { name: "Philippines (the)", iso2: "PH", iso3: "PHL", numeric: "608" },
  ...
  { name: "Republic of North Macedonia", iso2: "MK", iso3: "MKD", numeric: "807" },
  { name: "Romania", iso2: "RO", iso3: "ROU", numeric: "642" },
  { name: "Russian Federation (the)", iso2: "RU", iso3: "RUS", numeric: "643" },
  ...
  { name: "Saint Helena, Ascension and Tristan da Cunha", iso2: "SH", iso3: "SHN", numeric: "654" },
  { name: "Saint Kitts and Nevis", iso2: "KN", iso3: "KNA", numeric: "659" },
  { name: "Saint Lucia", iso2: "LC", iso3: "LCA", numeric: "662" },
  { name: "Saint Martin (French part)", iso2: "MF", iso3: "MAF", numeric: "663" },
  { name: "Saint Pierre and Miquelon", iso2: "PM", iso3: "SPM", numeric: "666" },
  { name: "Saint Vincent and the Grenadines", iso2: "VC", iso3: "VCT", numeric: "670" },
  ...
  { name: "Sint Maarten (Dutch part)", iso2: "SX", iso3: "SXM", numeric: "534" },
  ...
  { name: "South Georgia and the South Sandwich Islands", iso2: "GS", iso3: "SGS", numeric: "239" },
  ...
  { name: "Sudan (the)", iso2: "SD", iso3: "SDN", numeric: "729" },
  ...
  { name: "Taiwan (Province of China)", iso2: "TW", iso3: "TWN", numeric: "158" },
  { name: "Tajikistan", iso2: "TJ", iso3: "TJK", numeric: "762" },
  { name: "Tanzania, United Republic of", iso2: "TZ", iso3: "TZA", numeric: "834" },
  ...
  { name: "Turks and Caicos Islands (the)", iso2: "TC", iso3: "TCA", numeric: "796" },
  ...
  { name: "United Arab Emirates (the)", iso2: "AE", iso3: "ARE", numeric: "784" },
  { name: "United Kingdom of Great Britain and Northern Ireland (the)", iso2: "GB", iso3: "GBR", numeric: "826" },
  { name: "United States Minor Outlying Islands (the)", iso2: "UM", iso3: "UMI", numeric: "581" },
  { name: "United States of America (the)", iso2: "US", iso3: "USA", numeric: "840" },
  ...
  { name: "Venezuela (Bolivarian Republic of)", iso2: "VE", iso3: "VEN", numeric: "862" },
