...
#
# source://dalli//lib/dalli/protocol/meta/key_regularizer.rb#14
class Dalli::Protocol::Meta::KeyRegularizer
  class << self
    # source://dalli//lib/dalli/protocol/meta/key_regularizer.rb#23
    def decode(encoded_key, base64_encoded); end

    # source://dalli//lib/dalli/protocol/meta/key_regularizer.rb#17
    def encode(key); end
  end
end
...
#
# source://dalli//lib/dalli/socket.rb#133
class Dalli::Socket::UNIX < ::UNIXSocket
  ...
  #
  # source://dalli//lib/dalli/socket.rb#138
  def options; end
  ...
  class << self
    # source://dalli//lib/dalli/socket.rb#140
