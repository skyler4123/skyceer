...
class Rswag::Api::Middleware
  ...
  # source://rswag-api//lib/rswag/api/middleware.rb#54
  def load_json(filename); end

  # source://rswag-api//lib/rswag/api/middleware.rb#50
  def load_yaml(filename); end

  # source://rswag-api//lib/rswag/api/middleware.rb#42
  def parse_file(filename); end

  # source://rswag-api//lib/rswag/api/middleware.rb#58
