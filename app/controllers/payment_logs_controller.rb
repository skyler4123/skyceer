class PaymentLogsController < ApplicationController
  ...
  private
    ...
    def payment_log_params
      params.expect(payment_log: [ :seller_id, :seller_type, :buyer_id, :buyer_type, :payment_order_id, :payment_method_id, :payment_discount_id, :payment_invoice_id, :action, :amount, :note ])
    end
end
