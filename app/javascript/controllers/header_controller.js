    ...
    return `
      <div class="flex flex-row justify-between items-center w-full h-full px-4 py-4 border-b-2">
        <div>
          <a href="/">
            <div class="flex flex-row gap-x-2 justify-center items-center">
              <div class="flex flex-row w-12 h-12 z-50" data-controller="${identifier(LogoController)}"></div>
        ...
        <div class="flex flex-row justify-center items-center gap-x-2">
          <div class="flex flex-row" data-controller="${identifier(DarkmodeController)}"></div>
          <div 
            role="profile"
