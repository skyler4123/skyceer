...
export const EducationScoreBoardsApi = {
  ...
  index({params, headers} = {}) {
    return axios.get(`/education_score_boards`, { params: params, headers: {...defaultHeaders(), ...headers} })
  },

  education_class_id({params, headers} = {}) {
    return axios.get(`/education_score_boards/education_class_id`, { params: params, headers: {...defaultHeaders(), ...headers} })
  },
