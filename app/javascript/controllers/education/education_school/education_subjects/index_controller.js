...
export default class Education_EducationSchool_EducationSubjects_IndexController extends Education_EducationSchool_LayoutController {
  ...
  educationSubjects() {
    return ServerData.data.education_subjects
  }
    ...
    return `
      <div class="mx-auto w-4/5 mt-10 flex flex-col gap-y-4">
        <div class="flex justify-between items-center">
          <h2 class="text-xl font-medium">Subjects</h2>
          <a class="rounded-lg py-2 px-5 bg-slate-800 text-white" href="/education_subjects/new">New Subject</a>
        </div>
