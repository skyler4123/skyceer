  ...
  schoolAsideData() {
    return [
      ...
      },
      {
        ...
        icon: `
          <svg class="fill-slate-200" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="800px" height="800px" viewBox="0 0 470.775 470.775" xml:space="preserve">
            <g>
              <g>
      ...
      {
        name: "Payments",
        url: `${this.navigationUrlValue}/payment_orders`,
        icon: `
