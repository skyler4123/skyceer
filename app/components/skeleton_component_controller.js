...
export default class SkeletonComponentController extends ApplicationComponentController {
  ...
  get initHTML() {
    return {
      ...
      `,
      'image': `
        <div data-${this.identifier}-target="skeleton" role="status" class="space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center">
      ...
      `,
      'video': `
        <div data-${this.identifier}-target="skeleton" role="status" class="flex items-center justify-center h-56 max-w-sm bg-gray-300 rounded-lg animate-pulse dark:bg-gray-700">
      ...
      `,
      'text': `
        <div data-${this.identifier}-target="skeleton" role="status" class="space-y-2.5 animate-pulse max-w-lg">
      ...
      `,
      'card': `
        <div data-${this.identifier}-target="skeleton" role="status" class="max-w-sm p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700">
      ...
      `,
      'list': `
        <div data-${this.identifier}-target="skeleton" role="status" class="max-w-md p-4 space-y-4 border border-gray-200 divide-y divide-gray-200 rounded shadow animate-pulse dark:divide-gray-700 md:p-6 dark:border-gray-700">
      ...
      `,
      'testimonial': `
        <div data-${this.identifier}-target="skeleton" role="status" class="animate-pulse">
