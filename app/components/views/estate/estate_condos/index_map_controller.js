...
export default class Views_Estate_EstateCondos_IndexMapController extends Libs_Map_Openlayers_IndexController {
  static values = {
    ...super.values,
    queryParams: Object
  }
  ...
  initComplete() {
    ...
    this.initOpenUrlOnClickFeature({url: "/estate_condos/"})
  }
  ...
  async queryParamsValueChanged(value, previousValue) {
    const res = await EstateCondosApi.index({params: value})
    let points = res.data
