class Api::ProjectGroupAppointmentsController < Api::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @project_group_appointment.save
        format.html { redirect_to @project_group_appointment, notice: "Project group apointment was successfully created." }
  ...
  def update
    respond_to do |format|
      if @project_group_appointment.update(project_group_appointment_params)
        format.html { redirect_to @project_group_appointment, notice: "Project group apointment was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to project_group_appointments_path, status: :see_other, notice: "Project group apointment was successfully destroyed." }
  ...
  private
    ...
    def project_group_appointment_params
      params.expect(project_group_appointment: [ :project_group_id, :appoint_to_id, :appoint_to_type ])
    end
end
