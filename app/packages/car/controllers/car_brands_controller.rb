class CarBrandsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @car_brand.save
        format.html { redirect_to car_brand_url(@car_brand), notice: "Car brand was successfully created." }
  ...
  def update
    respond_to do |format|
      if @car_brand.update(car_brand_params)
        format.html { redirect_to car_brand_url(@car_brand), notice: "Car brand was successfully updated." }
