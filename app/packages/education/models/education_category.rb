class EducationCategory < ApplicationRecord
  ...
  has_many :education_schools, through: :education_category_appointments, source: :education_category_appointmentable, source_type: 'EducationSchool'
  ...
  has_many :education_parents, through: :education_category_appointments, source: :education_category_appointmentable, source_type: 'EducationParent'
