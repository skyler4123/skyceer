class EducationClassesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @education_class.save
        format.html { redirect_to education_class_url(@education_class), notice: "Education class was successfully created." }
  ...
  def update
    respond_to do |format|
      if @education_class.update(education_class_params)
        format.html { redirect_to education_class_url(@education_class), notice: "Education class was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to education_classes_url, notice: "Education class was successfully destroyed." }
