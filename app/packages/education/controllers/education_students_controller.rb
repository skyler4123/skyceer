class EducationStudentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @education_student.save
        format.html { redirect_to education_student_url(@education_student), notice: "Education student was successfully created." }
  ...
  def update
    respond_to do |format|
      if @education_student.update(education_student_params)
        format.html { redirect_to education_student_url(@education_student), notice: "Education student was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to education_students_url, notice: "Education student was successfully destroyed." }
  ...
  private
    ...
    def education_student_params
      params.require(:education_student).permit(:education_user_id, :name)
    end
end
