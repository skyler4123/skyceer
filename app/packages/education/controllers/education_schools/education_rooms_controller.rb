class EducationSchools::EducationRoomsController < EducationsController
  ...
  def create
    ...
    respond_to do |format|
      if @education_room.save
        format.html { redirect_to education_school_education_rooms_path, notice: "Education room was successfully created." }
  ...
  private
    ...
    def education_room_params
      params.require(:education_room).permit(:name, :category)
    end
end
