class EducationCategoryAppointmentsController < ApplicationController
  ...
  private
    ...
    def education_category_appointment_params
      params.expect(education_category_appointment: [ :education_class_id, :education_room_id, :education_teacher_id, :education_student_id, :education_subject_id, :education_course_id, :education_exam_id, :education_question_id, :education_lesson_id, :education_shift_id ])
    end
end
