class EducationRoomsController < ApplicationController
  ...
  def index
    @education_rooms = EducationRoom.all
  end
  ...
  def create
    ...
    respond_to do |format|
      if @education_room.save
        format.html { redirect_to education_room_url(@education_room), notice: "Education room was successfully created." }
  ...
  def update
    respond_to do |format|
      if @education_room.update(education_room_params)
        format.html { redirect_to education_room_url(@education_room), notice: "Education room was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to education_rooms_url, notice: "Education room was successfully destroyed." }
  ...
  private
    ...
    def education_room_params
      params.require(:education_room).permit(:education_school_id, :name)
    end
end
