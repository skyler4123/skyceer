module User::ArticlePostImageConcern
  ...
  included do
    ...
    # validates :image_attachments, attached: true, content_type: ['image/png', 'image/jpg', 'image/jpeg'], dimension: { width: { min: 800, max: 2400 }, height: { min: 600, max: 1800 }, message: 'is not given between dimension' }
