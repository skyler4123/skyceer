...
/**
   ...
   * @returns {boolean}
   * @public
   */static get displayInToolbox(){return!0}
/**
...
/**
   ...
   */static get toolbox(){return{icon:e,title:"Raw HTML"}}
/**
...
/**
   ...
   */constructor({data:e,config:t,api:a,readOnly:i}){this.api=a,this.readOnly=i,this.placeholder=t.placeholder||r.DEFAULT_PLACEHOLDER,this.CSS={baseClass:this.api.styles.block,input:this.api.styles.input,wrapper:"ce-rawtool",textarea:"ce-rawtool__textarea"},this.data={html:e.html||""},this.textarea=null,this.resizeDebounce=null
/**
   * Return Tool's view
   *
...
/**
   ...
   * @public
   */}save(e){return{html:e.querySelector("textarea").value}}
/**
   * Default placeholder for RawTool's textarea
   *
   * @public
   * @returns {string}
   */static get DEFAULT_PLACEHOLDER(){return"Enter HTML code"}static get sanitize(){return{html:!0}}
/**
   * Textarea change event
   *
   * @returns {void}
   */onInput(){this.resizeDebounce&&clearTimeout(this.resizeDebounce),this.resizeDebounce=setTimeout((()=>{this.resize()}),200)
/**
   * Resize textarea to fit whole height
   *
   * @returns {void}
   */}resize(){this.textarea.style.height="auto",this.textarea.style.height=this.textarea.scrollHeight+"px"}}export{r as default};
